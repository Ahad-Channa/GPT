...
const goodpicksOffersRoutes = require('./routes/goodpicksOffers');
const directOffersRoutes = require('./routes/directOffers');
...
app.use('/api/goodpicks-offers', goodpicksOffersRoutes);
app.use('/api/direct-offers', directOffersRoutes);
