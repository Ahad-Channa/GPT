  ...
  return (
    <DashboardLayout>
      <motion.div variants={container} initial="hidden" animate="show" className="max-w-4xl mx-auto space-y-6 pb-20">
        ...
        {profile.isPrivate && (
          <motion.div variants={item} className="p-4 rounded-2xl bg-[#0c101b] border border-indigo-500/20 flex items-center justify-center gap-3 text-indigo-300">
            <FiShield className="text-lg" />
            <span className="text-sm font-medium">This profile is private. Detailed offer information is hidden.</span>
          </motion.div>
        )}
